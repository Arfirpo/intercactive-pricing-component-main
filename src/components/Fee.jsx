    ...
    <section className="flex flex-col justify-evenly items-center w-full h-[60%] border-gray-300 border-b px-[18px] pb-9">
      <div className="flex flex-col justify-evenly h-[75%] w-full text-center text-l ">
        ...
        <p className="flex items-center justify-center gap-2 text-2xl">
          <span className="text-darkDesaturatedBlue font-bold text-6xl">$</span>
          <span className="text-darkDesaturatedBlue font-bold text-6xl">16.00</span> / month
        </p>
      </div>
      <div className="text-2xl flex items-center justify-around w-full h-[15%]">
        <p>Monthly Billing</p>
        <ToggleSlider />
        <p>Year Billing</p>
